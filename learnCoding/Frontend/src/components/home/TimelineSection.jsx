...
{/* left section */}
        <div className='w-[100%] sm:w-[45%] mt-[200px] flex flex-col gap-5'>
            {
        ...
        <div className='w-full relative mt-[120px] sm:mt-0 flex items-center justify-center flex-col shadow-blue-200'>
          ...
          <img  src={timelineImage}
            ...
            <div className='absolute -bottom-[110px] bg-caribbeangreen-700 mb-5 flex flex-row text-white uppercase py-7
